...
namespace eval ::optrace {
  variable script "C:/CODexp/Lab6/apply/apply.runs/impl_1/sort.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/CODexp/Lab6/apply/apply.runs/synth_1/sort.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force sort_physopt.dcp
